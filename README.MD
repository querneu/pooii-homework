...
- ### Metodos
    ...
    * [setMatricula] - Metodo que retorna o valor inserido em [self._matricula], herdado de [Pessoa]
...
- ### Metodos
    ...
    * [setCodigo] - Metodo que retorna o valor inserido em [self._codigo], herdado de [Pessoa]
